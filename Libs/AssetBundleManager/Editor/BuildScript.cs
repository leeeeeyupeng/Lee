...
namespace AssetBundles
{
	public class BuildScript
	{
        ...
        public static string AssetBundlesOutputPath()
        {
            ...
            outputPath = Path.Combine("preRes", Utility.AssetBundlesPath());
            return outputPath;
        }
        ...
        public static void BuildAssetBundlesClearMainfest()
        {
            string outputPath = AssetBundlesOutputPath();

            BuildAssetBundlesClearMainfestForDir(outputPath);
        }

        public static void BuildAssetBundlesClearMainfestForDir(string dir)
        {
            ...
            {
                BuildAssetBundlesClearMainfestForDir(d);
            }
        }
